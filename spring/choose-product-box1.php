  ...
  if(count($errors) === 0){
    ...
    if(empty($user)){
      ...
      if(!password_verify($post['input_password'], $user['password'])){
        ...
        header('Location: my-payment-box1.php'); // Redirige vers la page my-account
      }
...
if(!empty($_COOKIE['authToken'])){
  header('Location: my-payment-box1.php');
}
        ...
        <!-- <div class="ftco-animate" data-scrollax=" properties: { translateY: '70%' }"> -->
          <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-6 col-xl-5" id="form">
              <form method="post">
                <p>Vous avez choisi la formule Classique, vous n'allez pas être décu :)</p>
